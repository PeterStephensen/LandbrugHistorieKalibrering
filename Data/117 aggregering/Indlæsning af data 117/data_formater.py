...
df_jordareal = pd.read_csv('../../69 aggregering/Nationalregnskab/Data69/landbrugsdata_jordareal.csv')
df_jordpris = pd.read_csv('../../69 aggregering/Nationalregnskab/Data69/jordpris.csv')
df_tilskud = pd.read_csv('../../69 aggregering/Nationalregnskab/Data69/landbrugsdata_tilskud.csv')
df_grundskyld = pd.read_csv('../../69 aggregering/Nationalregnskab/Data69/grundskyld.csv')
df_timer_lon = pd.read_csv('../Nationalregnskab_117/Data117/Timer_lon_landbrugsdata.csv')
df_realkredit=pd.read_csv('../../69 aggregering/Nationalregnskab/Data69/rente_landbrugsdata.csv')
df_gamma=pd.read_csv('../Nationalregnskab_117/Data117/gamma.csv')
df_s=pd.read_csv('../Nationalregnskab_117/Data117/s.csv')
makrodata= dt.Gdx('../../69 aggregering/Nationalregnskab/Data69/konjunktur_juni2025.gdx')
