...
DATA69_DIR = BASE_DIR.parent / "Nationalregnskab" / "Data69"
...
# Indlæs data
df = pd.read_csv(DATA69_DIR / 'landbrugsdata_mængdeindeks.csv')
df_priser = pd.read_csv(DATA69_DIR / 'landbrugsdata_prisindeks.csv')
df_timer = pd.read_csv(DATA69_DIR / 'Timer_landbrugsdata.csv')
df_timeLon = pd.read_csv(DATA69_DIR / 'TimeLon_landbrugsdata.csv')
df_kapital = pd.read_csv(DATA69_DIR / 'Kapital_landbrugsdata.csv')
df_kapital_mængder = pd.read_csv(DATA69_DIR / 'landbrugsdata_mængdeindeks_kapital.csv')
df_kapital_pris = pd.read_csv(DATA69_DIR / 'landbrugsdata_prisindeks_kapital.csv')
df_toldssats = pd.read_csv(DATA69_DIR / 'landbrugsdata_toldssats.csv')
df_afgift = pd.read_csv(DATA69_DIR / 'landbrugsdata_afgift.csv')
df_produktion_løbende = pd.read_csv(DATA69_DIR / 'landbrugsdata.csv')
df_aggregater = pd.read_csv(DATA69_DIR / 'Aggregater_KL_M.csv')
df_aggregater_mjit = pd.read_csv(DATA69_DIR / 'Aggregater_Mjit.csv')
df_input = pd.read_csv(DATA69_DIR / 'input_landbrugsdata.csv')
df_jordareal = pd.read_csv(DATA69_DIR / 'landbrugsdata_jordareal.csv')
df_jordpris = pd.read_csv(DATA69_DIR / 'jordpris.csv')
df_tilskud = pd.read_csv(DATA69_DIR / 'landbrugsdata_tilskud.csv')
df_timer_lon = pd.read_csv(DATA69_DIR / 'Timer_lon_landbrugsdata.csv')
df_realkredit = pd.read_csv(DATA69_DIR / 'rente_landbrugsdata.csv')
makrodata = dt.Gdx(str(DATA69_DIR / 'konjunktur_juni2025.gdx'))
df_grundskyld = pd.read_csv(DATA69_DIR / 'grundskyld.csv')
...
brancher = ['01000', '10120', 'REST', 'Privat']
