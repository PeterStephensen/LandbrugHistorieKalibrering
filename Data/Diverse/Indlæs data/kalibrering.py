...
def beregn_brugerpris_jord_69(v, r):
    ...
    grundskyld_korr.index = grundskyld_korr.index.astype(int)
...
def beregn_tau_MD(data, results, mapping, brancher):
    ...
    afgift = results[afgift_key]  # ← tilføj denne linje
    afgift[i] = afgift[i].replace(mapping)   # ← tilføj denne linje
